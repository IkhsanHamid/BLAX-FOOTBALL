...
export default function PaymentComponent({
  ...
  const fetchPaymentData = async () => {
    try {
      ...
      showError("Failed to fetch payment data");
      setPaymentData(null);
    } finally {
      setLoading(false);
    }
  ...
  const copyBookId = () => {
    if (paymentData?.bookId) {
      ...
      showSuccess("Book ID copied to clipboard");
    }
  };
    ...
    switch (paymentData.status) {
      case "pending":
        return {
          ...
          description:
            "Silahkan selesaikan pembayaran anda menggunakan QRIS dibawah ini.",
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            ...
            <div className="text-center">
              <h1 className="text-3xl font-bold text-blue-600 mb-2 mt-10">
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="text-sm text-yellow-700 leading-relaxed">
                      <strong>📝 Penting:</strong> Simpan ID booking Anda
                      sebagai bukti pembayaran atau berikan kepada admin jika
                      pembayaran gagal.
                    </div>
                  </div>
                </CardContent>
                    ...
                    <div className="bg-white border-2 border-gray-200 rounded-lg p-6 inline-block mb-4">
                      <img
                        ...
                        onError={(e) => {
                          ...
                          showError("Failed to load QRIS code");
                        }}
                      />
                    </div>
